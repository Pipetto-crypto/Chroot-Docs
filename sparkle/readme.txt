...
Use the -s option (linux-deploy start -s) to start the Xwayland server in the chroot through the script you can find here which will be installed the first time you use the -s option. By default this script will also launch a lxqt session because that's what I am using in my setup.
